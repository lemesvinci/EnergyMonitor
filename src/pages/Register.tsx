...
export default function Register({ onNavigate }: RegisterProps) {
  ...
  return (
    ...
    >
      {/* conteúdo principal */}
      <div className="relative w-full max-w-md bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8">
        ...
        <p className="text-center text-slate-600 mb-8">
          Comece a monitorar seu consumo elétrico
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          >
            {loading ? (
              <>
                <span className="spinner mr-2"></span> Criando conta...
              </>
            ) : (
              "Cadastrar"
            )}
